...
const DepositSuccess: FC<any> = ({ handleClose }) => {
    return (
        <div
            onClick={(e) => {
                e.stopPropagation();
            }}
            className="flex relative flex-col gap-4 justify-center items-center w-4/5 md:w-2/5 xl:w-1/5 h-64 p-4 rounded-lg bg-light-100 "
        >
            ...
            <svg
                className="h-12 stroke-blue-100"
                viewBox="0 0 22 22"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
            >
            ...
            <span className="font-medium text-xl">Setor berhasil!</span>
        </div>
    );
};
