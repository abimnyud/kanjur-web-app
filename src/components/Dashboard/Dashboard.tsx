            ...
            <div className="recent-activity-box overflow-scroll">
                <ul className="recent-transactions">
                    <li key="header" className="py-2 ">
                        ...
                        <div className="font-semibold text-sm w-1/5">Aksi</div>
                        <div className="font-semibold text-sm w-1/5">Setor</div>
                        <div className="font-semibold text-sm w-1/5">Tarik</div>
                        <p className="font-semibold text-sm w-1/5">Waktu</p>
                    </li>
                        ...
                        return (
                            <li key={`transaction-${id}`} className="py-4">
                                ...
                                <span className="text-gray-200 text-sm w-1/5">
                                    {currency.format(transaction.deposit)}
                                </span>
                                <span className="text-gray-200 text-sm w-1/5">
                                    {currency.format(transaction.withdraw)}
                                </span>
                                <span className="text-gray-200 text-sm w-1/5">
                                    {time}
                                </span>
